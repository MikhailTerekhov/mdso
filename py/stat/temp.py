...
parser.add_argument("output", help="Translational drift is saved here")
...
def get_errors(traj_fname, inds_fname, gt_fname, first, is_our):
    ...
    return np.average(trans_drift_avg)

trans_drift = get_errors(args.traj, args.inds, args.gt, args.first, True)
print(trans_drift, file=open(args.output, 'w'))
